...
def list_offers(user_id: int, username: str, show: str = "active", status: str = "ALL", invoice: str = "ALL", paid: str = "ALL", q: str | None = None):
    """
    show:
...
def render_invoice_pdf(
    ...
    c.drawString(40, h - 130, f"Klijent: {offer.get('client_name') or ''}")
