...
def list_offers(
    user_id: int,
    username: str,
    show: str | None = "active",
    status: str | None = "ALL",
    invoice: str | None = "ALL",
    paid: str | None = "ALL",
    ...
    """
    username_l = (username or "").strip().lower()
    show_l = (show or "active").strip().lower()
    if show_l not in {"active", "archived", "all"}:
        show_l = "active"
    ...
    sql = """
      select
        ...
        o.last_view_at
      from offers o
      where o.user_id=%s and o.user_name=%s
    """
    params: list = [user_id, username_l]

    if show_l == "active":
        sql += " and o.archived=false"
    elif show_l == "archived":
        sql += " and o.archived=true"
    ...
    if invoice_u == "YES":
        sql += " and o.invoice_no is not null"
    elif invoice_u == "NO":
        sql += " and o.invoice_no is null"

    if paid_u == "PAID":
        sql += " and o.paid_at is not null"
    elif paid_u == "UNPAID":
        sql += " and o.paid_at is null"
